  ...
  return (
    ...
    >
      <div className=' ' data-aos="fade" data-aos-duration="1500">
        <img src={process.env.PUBLIC_URL+'/images/release/section2_p01.png'} alt="" className='w-full'/>
      </div>
      <div className='pt-12 pb-28' data-aos="fade" data-aos-duration="1500">
        <img src={process.env.PUBLIC_URL+'/images/release/section2_p02.png'} alt="" className='w-full'/>
      </div>
